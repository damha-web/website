...
import { ArrowRight, Users, Target, TrendingUp, Award, PlusCircle, CheckCircle2, ChevronRight, Share2, Search, CalendarCheck } from "lucide-react";
...
const VALUES = [
    { icon: <Target className="w-10 h-10 text-[#E47B41]" />, title: "본질 지향 전략", description: "단기 성과에 집착하지 않고 병원의 고유한 브랜드 가치 발굴과 지속적 성장을 추구합니다." },
    { icon: <TrendingUp className="w-10 h-10 text-[#E47B41]" />, title: "데이터 기반 실행", description: "치밀한 데이터 분석을 바탕으로, 근거 있는 전략과 측정 가능한 결과를 증명합니다." },
    { icon: <Users className="w-10 h-10 text-[#E47B41]" />, title: "현장 중심 사고", description: "병원 현장에서 경험을 쌓은 전문가들이 환자와 의료진 모두를 이해하는 언어를 씁니다." },
    { icon: <Award className="w-10 h-10 text-[#E47B41]" />, title: "파트너십 신뢰", description: "95% 이상의 압도적인 수치가 말해주는, 한번 맺은 인연을 소중히 여기는 파트너십." }
];
    ...
    return (
        <main className="min-h-screen bg-white">
            ...
            <section className="pt-32 pb-20 bg-gradient-to-b from-gray-50 to-white overflow-hidden relative">
                <div className="absolute top-[-10%] right-[-5%] w-[500px] h-[500px] bg-[#E47B41]/10 rounded-full blur-[100px] pointer-events-none" />
                <div className="absolute bottom-[0] left-[-10%] w-[400px] h-[400px] bg-[#E47B41]/5 rounded-full blur-[100px] pointer-events-none" />
                ...
                <div className="container mx-auto px-6 max-w-5xl relative z-10">
                    ...
                    >
                        <span className="inline-block text-[#E47B41] font-bold tracking-widest text-sm font-montserrat uppercase mb-6 bg-[#E47B41]/10 px-5 py-2 rounded-full">
                            About DAMHA
                        </span>
            ...
            <section className="py-24 bg-white relative">
                <div className="container mx-auto px-6 max-w-6xl">
                    ...
                    >
                        <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-[#E47B41]/20 to-transparent opacity-50 pointer-events-none" />
                        <div className="grid md:grid-cols-2 gap-12 md:gap-20 relative z-10">
                            <div>
                                <h3 className="text-3xl font-bold mb-8 text-[#E47B41] border-b border-white/10 pb-4">Company Overview</h3>
                            ...
                            <div>
                                <h3 className="text-3xl font-bold mb-8 text-[#E47B41] border-b border-white/10 pb-4">Contact Info</h3>
                                <div className="space-y-6">
                                    <div className="flex flex-col">
            ...
            <section className="py-32 bg-[#0E0E0E] overflow-hidden relative">
                ...
                <div className="container mx-auto px-6 max-w-7xl relative z-10">
                    ...
                    >
                        <span className="inline-block px-4 py-1.5 rounded-full text-xs font-bold tracking-[0.3em] uppercase mb-6 text-[#E47B41]" style={{ background: 'rgba(228,123,65,0.1)', border: '1px solid rgba(228,123,65,0.2)' }}>
                            Organisation
                        </span>
                        <h2 className="text-5xl md:text-6xl font-black text-white mb-6 leading-tight">
                            우리가 만드는<br />
                            <span style={{ background: 'linear-gradient(90deg, #E47B41, #F7B267)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
                                체계적인 조직과 전문성
                            </span>
                        </h2>
                    ...
                    <div className="flex flex-col items-center mb-20">
                        ...
                        >
                            <div className="relative px-12 py-6 rounded-2xl font-black text-2xl text-white text-center" style={{ background: 'linear-gradient(135deg, #E47B41 0%, #F7B267 100%)', boxShadow: '0 20px 60px rgba(228,123,65,0.4)' }}>
                                대표이사
                        ...
                        {/* Vertical stem */}
                        <div className="w-[1px] h-10" style={{ background: 'linear-gradient(to bottom, #E47B41, rgba(255,255,255,0.15))' }}></div>
            ...
            <section className="py-24 bg-[#1F1F1F] text-white">
                <div className="container mx-auto px-6 max-w-6xl">
                    <div className="grid md:grid-cols-2 gap-16 lg:gap-24">
                        ...
                        >
                            <h2 className="text-3xl font-bold mb-2 text-white">대표이사 <span className="text-[#E47B41]">약력</span></h2>
                            <p className="text-[#E47B41] font-medium mb-8">정승우 대표</p>
                            <ul className="space-y-4">
                                {CEO_PROFILE.map((item, index) => (
                                    <li key={index} className="flex items-start gap-4">
                                        <ChevronRight className="flex-shrink-0 w-5 h-5 text-[#E47B41] mt-0.5" />
                        ...
                        <motion.div
                            ...
                            whileInView={{ opacity: 1, x: 0 }}
                            viewport={{ once: false, amount: 0.2 }}
                            className="bg-gradient-to-br from-[#E47B41]/20 to-transparent rounded-3xl p-10 border border-[#E47B41]/30"
                        >
                            <h2 className="text-3xl font-bold mb-2 text-white">전문가 그룹 <span className="text-[#E47B41]">강점</span></h2>
                            ...
                            <ul className="space-y-5">
                                {TEAM_STRENGTH.map((item, index) => (
                                    <li key={index} className="flex items-start gap-4 pb-4 border-b border-white/10 last:border-0 last:pb-0">
                                        <div className="w-1.5 h-1.5 rounded-full bg-[#E47B41] mt-2.5 flex-shrink-0" />
            ...
            <section className="py-32 bg-gradient-to-b from-white via-gray-50/50 to-white overflow-hidden relative">
                    ...
                    <svg className="w-full h-full" preserveAspectRatio="none">
                        <defs>
                            <linearGradient id="pathGradient" x1="0%" y1="0%" x2="100%" y2="0%">
                                <stop offset="0%" stopColor="#E47B41" stopOpacity="0.1" />
                                <stop offset="50%" stopColor="#E47B41" stopOpacity="0.3" />
                                <stop offset="100%" stopColor="#E47B41" stopOpacity="0.1" />
                            </linearGradient>
                        </defs>
                        <path
                ...
                <div className="container mx-auto px-6 max-w-7xl relative z-10">
                    <div className="text-center mb-20">
                        <span className="inline-block px-3 py-1 bg-red-50 text-[#E47B41] rounded-full text-xs font-bold tracking-widest uppercase mb-4">Core Strategy</span>
                        <h2 className="text-4xl md:text-5xl font-black text-[#1F1F1F] mb-6">
                            MOT 기반 <span className="text-[#E47B41]">고객 여정 설계</span>
                        </h2>
                    ...
                    <div className="relative">
                            ...
                            {MOT_STAGES.map((stage, idx) => {
                                ...
                                return (
                                    <motion.div
                                        ...
                                        className={`relative bg-white rounded-2xl p-8 hover:bg-[#1F1F1F] hover:text-white transition-all duration-500 group border-2 border-gray-100 hover:border-[#E47B41] hover:shadow-2xl hover:shadow-[#E47B41]/20 ${orderClass}`}
                                        style={{
                                    ...
                                    {(idx === 0 || idx === 1) && (
                                        ...
                                        >
                                            <div className="flex items-center gap-1">
                                                <div className="w-8 h-0.5 bg-gradient-to-r from-[#E47B41]/60 to-[#E47B41]/20"></div>
                                                <ChevronRight className="w-6 h-6 text-[#E47B41]" strokeWidth={2.5} />
                                            </div>
                                        </motion.div>
                                    )}
                                    ...
                                    {idx === 2 && (
                                        ...
                                        >
                                            <div className="flex flex-col items-center gap-1">
                                                <div className="w-0.5 h-8 bg-gradient-to-b from-[#E47B41]/60 to-[#E47B41]/20"></div>
                                                <ChevronRight className="w-6 h-6 text-[#E47B41] rotate-90" strokeWidth={2.5} />
                                            </div>
                                        </motion.div>
                                    )}
                                    ...
                                    {(idx === 3 || idx === 4) && (
                                        ...
                                        >
                                            <div className="flex items-center gap-1">
                                                <ChevronRight className="w-6 h-6 text-[#E47B41] rotate-180" strokeWidth={2.5} />
                                                <div className="w-8 h-0.5 bg-gradient-to-l from-[#E47B41]/60 to-[#E47B41]/20"></div>
                                            </div>
                                        </motion.div>
                                    )}
                                    ...
                                    {/* Progress indicator */}
                                    <motion.div
                                        className="absolute -top-3 -left-3 w-12 h-12 rounded-full bg-gradient-to-br from-[#E47B41] to-[#F7B267] flex items-center justify-center font-black text-white shadow-lg"
                                    ...
                                    {/* Icon */}
                                    <div className="w-14 h-14 bg-gray-50 shadow-md rounded-xl flex items-center justify-center mb-6 text-[#E47B41] group-hover:bg-[#E47B41] group-hover:text-white transition-colors relative z-10">
                                        {stage.icon}
                                    </div>
                                    ...
                                    <div className="pt-4 border-t border-gray-200 group-hover:border-gray-700 relative z-10">
                                        <span className="block text-sm font-bold text-[#E47B41] uppercase tracking-wider mb-2">Key Channels</span>
                                        <p className="text-base font-medium text-gray-600 group-hover:text-gray-300">{stage.channels}</p>
                                    </div>

                                    {/* Hover glow effect */}
                                    <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-[#E47B41]/0 to-[#E47B41]/0 group-hover:from-[#E47B41]/10 group-hover:to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
                                </motion.div>
                                );
                            })}
                        </div>
                        ...
                        >
                            <div className="inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-[#E47B41]/10 to-[#F7B267]/10 rounded-full border border-[#E47B41]/30">
                                <motion.div
                                    animate={{ rotate: 360 }}
                                    transition={{ duration: 4, repeat: Infinity, ease: "linear" }}
                                    className="w-6 h-6 rounded-full border-2 border-[#E47B41] border-t-transparent"
                                />
                                <span className="text-sm font-bold text-[#E47B41]">지속적인 순환 여정 (Continuous Journey Loop)</span>
                            </div>
                        </motion.div>
                    </div>
                </div>
            ...
            <section className="py-32 bg-white">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-20">
                        <h2 className="text-4xl md:text-5xl font-black text-[#1F1F1F] mb-6">
                            <span className="text-[#E47B41]">핵심 가치</span>와 원칙
                        </h2>
                ...
                <div className="container mx-auto px-6 text-center">
                    ...
                    >
                        <h2 className="text-4xl md:text-5xl font-black mb-8 leading-tight">
                            담하와 함께<br />
                            경이로운 <span className="text-[#E47B41]">성공 스토리</span>를 시작하세요
                        </h2>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center mt-12">
                            <MagneticWrapper>
                                <Link
                                    href="/services"
                                    className="inline-flex items-center gap-2 px-8 py-4 bg-[#E47B41] text-white font-bold rounded-full hover:bg-red-700 transition-colors text-lg"
                                >
                                    서비스 알아보기
                                    <ArrowRight size={20} />
                                </Link>
