...
import PortfolioModal, { GradeBadge } from "./PortfolioModal";
                ...
                <div className="mb-10 space-y-4">
                    ...
                    <div className="flex flex-wrap gap-2 justify-center">
                        <button
                            ...
                            className={`px-4 py-2 rounded-full text-sm font-semibold transition-all ${gradeFilter === "ALL"
                        ...
                        {GRADE_FILTERS.map((grade) => (
                            <button
                                ...
                                className={`px-4 py-2 rounded-full text-sm font-semibold transition-all ${gradeFilter === grade
                                        ? "bg-secondary text-white"
                                        : "bg-gray-100 text-text-sub hover:bg-gray-200"
                                    }`}
                            >
                    ...
                    <div className="flex flex-wrap gap-2 justify-center overflow-x-auto">
                        <button
                            ...
                            className={`px-3 py-1.5 rounded-full text-xs font-medium transition-all ${deptFilter === "ALL"
                        ...
                        {DEPT_FILTERS.map((dept) => (
                            <button
                                ...
                                className={`px-3 py-1.5 rounded-full text-xs font-medium transition-all ${deptFilter === dept
                                        ? "bg-primary/10 text-primary"
                                        : "bg-gray-50 text-text-sub hover:bg-gray-100"
                                    }`}
                            >
                ...
                <AnimatePresence>
                    {filtered.length === 0 && (
                        <motion.p
                            ...
                            exit={{ opacity: 0 }}
                            className="text-center text-text-sub py-20"
                        >
                            해당 조건의 프로젝트가 없습니다.
                        </motion.p>
                    )}
