                ...
                >
                    ...
                    <motion.div variants={itemVariants} className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-2 transition-all duration-300 flex flex-col group relative overflow-hidden">
                        ...
                        <div className="h-28 mb-6 relative flex flex-col justify-end w-full">
                            <div className="flex justify-between items-center mb-4">
                                ...
                                <div className="flex items-center text-[10px] text-green-600 font-bold bg-green-50 px-1.5 py-0.5 rounded-full">
                                    <ArrowUpRight size={10} className="mr-0.5" /> Continuous
                                </div>
                            </div>
                        ...
                        <div className="mt-auto relative z-10">
                            <span className="text-5xl font-bold font-montserrat text-secondary mb-3 block leading-none">10<span className="text-primary">+</span></span>
                            <p className="text-lg font-bold text-text-main mb-1">에이전시 전문 경력</p>
                            <p className="text-sm text-text-sub leading-relaxed">10년 이상의 실무 노하우</p>
                        </div>
                    </motion.div>
                        ...
                        <div className="h-28 mb-6 relative flex flex-col justify-end w-full">
                            ...
                            <div className="w-full flex items-end justify-between h-14 gap-1.5 px-1 relative z-10">
                                ...
                                <motion.div className="w-full bg-primary rounded-t-sm relative group-hover:bg-accent transition-colors duration-300 shadow-md shadow-primary/20" variants={{ hidden: { height: 0 }, show: { height: "100%", transition: { duration: 0.6, delay: 0.5 } } }}>
                                    <div className="absolute -top-4 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-[9px] font-bold text-primary">MAX</div>
                                </motion.div>
                            </div>
                        </div>

                        <div className="mt-auto relative z-10">
                            <span className="text-5xl font-bold font-montserrat text-secondary mb-3 block leading-none">500<span className="text-primary">+</span></span>
                            <p className="text-lg font-bold text-text-main mb-1">누적 프로젝트 수</p>
                            <p className="text-sm text-text-sub leading-relaxed">검증된 성공 레퍼런스</p>
                        </div>
                    </motion.div>
                    ...
                    <motion.div variants={itemVariants} className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-2 transition-all duration-300 flex flex-col group relative overflow-hidden">
                        ...
                        <div className="h-28 mb-6 relative flex flex-col w-full">
                            <div className="flex justify-between items-center mb-2">
                                ...
                                <span className="text-[10px] text-gray-400 font-medium font-montserrat group-hover:text-primary transition-colors">Target 100%</span>
                            </div>
                            ...
                            <div className="relative w-full flex-1 flex items-center justify-center mt-2 group-hover:scale-105 transition-transform duration-500">
                                ...
                                <div className="absolute bottom-1 left-1/2 -translate-x-1/2 flex items-baseline gap-0.5">
                                    <span className="text-2xl font-bold text-secondary font-montserrat tracking-tighter">95</span><span className="text-xs font-bold text-primary">%</span>
                                </div>
                            </div>
                        </div>

                        <div className="mt-auto relative z-10">
                            <span className="text-5xl font-bold font-montserrat text-secondary mb-3 block leading-none">95<span className="text-primary">%</span></span>
                            <p className="text-lg font-bold text-text-main mb-1">고객 재의뢰율</p>
                            <p className="text-sm text-text-sub leading-relaxed">압도적인 파트너 만족도</p>
                        </div>
                    </motion.div>
                    ...
                    <motion.div variants={itemVariants} className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-2 transition-all duration-300 flex flex-col group relative overflow-hidden">
                        ...
                        <div className="mt-auto relative z-10">
                            <span className="text-5xl font-bold font-montserrat text-secondary mb-3 block leading-none">1:1</span>
                            <p className="text-lg font-bold text-text-main mb-1">전담 전문가 배정</p>
                            <p className="text-sm text-text-sub leading-relaxed">밀착 컨설팅 시스템</p>
                        </div>
                    </motion.div>
                </motion.div>
            </div>
